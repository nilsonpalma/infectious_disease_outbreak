...
For anayltical methods on each data source, please see below:
...
```
**Key Findings:**
- American Indian or Alaska Native (Non-Hispanic) populations experienced the highest burden across all 3 measures: Cumulative Incidence (per 100k), Attack Rate, and Severe Rate.
