---
title: "Milestone 3: Infectious Disease Outbreak in California"
...
- Combining morbidity datasets from CA and LA County into a single dataset
- Standardizing population data to match morbidity datasets
- Creating rate metrics for epidemiological analysis
- Analyzing outbreak patterns over time by demographic strata
...
- American Indian or Alaska Native populations experienced the highest peak incidence (~1,250 per 100,000)
